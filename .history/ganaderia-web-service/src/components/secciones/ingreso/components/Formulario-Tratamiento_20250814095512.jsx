...
const FormularioTratamiento = ({ setStep }) => {
  ...
  // ✅ MODIFICADO: Opciones para tipo de enfermedad CON "Otro"
  ...
  // ✅ NUEVO: Observar el valor seleccionado para mostrar el tip
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-100'>
      <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-4xl mb-10 mt-10'>
        ...
        {!modoMultiple ? (
          /* FORMULARIO INDIVIDUAL (Con modificaciones para "Otro") */
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              {/* ✅ MODIFICADO: Tipo de Enfermedad con "Otro" */}
              <div>
                <label
          ...
          /* ✅ FORMULARIO MÚLTIPLE (Con modificaciones para "Otro") */
                ...
                >
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    ...
                    <div>
                      ...
                      {/* ✅ NUEVO: Tip para "Otro" en modo múltiple */}
                    ...
                    {/* ✅ MODIFICADO: Descripción con placeholder dinámico */}
