...
const ListadoTratamiento = () => {
  ...
  const obtenerTratamientoHook = async (params) => {
    // Simulación de datos
    return {
      data: [
        {
          id_tratamiento: 1,
          nombre: "Antibiótico para diarrea",
          descripcion: "Tratamiento contra infección intestinal",
          tipo_enfermedad: "diarrea bacteriana",
          turno: "mañana",
          fecha_tratamiento: "2024-08-10",
        },
        {
          id_tratamiento: 2,
          nombre: "Broncodilatador",
          descripcion: "Para problemas respiratorios",
          tipo_enfermedad: "respiratorio",
          turno: "tarde",
          fecha_tratamiento: "2024-08-12",
        },
        {
          id_tratamiento: 3,
          nombre: "Suero hidratante",
          descripcion: "Rehidratación oral",
          tipo_enfermedad: "deshidratación",
          turno: "mañana",
          fecha_tratamiento: "2024-08-14",
        },
      ],
    };
  };
  ...
  // Función para eliminar tratamiento (SIN localStorage)
  const eliminarTratamiento = async () => {
    // Simulación sin localStorage - usar estado en memoria
    ...
    try {
      ...
      // Eliminar del estado local (simulación)
      setTratamientos((prev) =>
        prev.filter(
          (t) => t.id_tratamiento !== modalEliminar.tratamiento.id_tratamiento
        )
      );
